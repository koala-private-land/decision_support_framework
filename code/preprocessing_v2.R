...
pu.df <- merged[c("LGA", "NewPropID", "area", "cond", "connect", "risk", "dist_cov", "dist_pa", "koala_curr", "rank", "cccma_cgcm31",  "rank.cccma_cgcm31", "ccsr_miroc32hi", "rank.ccsr_miroc32hi", "ccsr_miroc32med", "rank.ccsr_miroc32med", "cnrm_cm3", "rank.cnrm_cm3", "csiro_mk30",  "rank.csiro_mk30", "gfdl_cm20",  "rank.gfdl_cm20", "gfdl_cm21",  "rank.gfdl_cm21", "giss_modeleh",  "rank.giss_modeleh", "giss_modeler",  "rank.giss_modeler", "iap_fgoals10g",  "rank.iap_fgoals10g", "inm_cm30",  "rank.inm_cm30", "ipsl_cm4",  "rank.ipsl_cm4", "mpi_echam5",  "rank.mpi_echam5", "mri_cgcm232a",  "rank.mri_cgcm232a", "ncar_ccsm30",  "rank.ncar_ccsm30", "ncar_pcm1",  "rank.ncar_pcm1", "ukmo_hadcm3",  "rank.ukmo_hadcm3", "ukmo_hadgem1",  "rank.ukmo_hadgem1", "MeanAdopt", "MeanWTA.tot", "MeanProp", "LValHa")] 
...
save(pu.df, file="./preprocessing/pu.df_22.10.22.RData")
