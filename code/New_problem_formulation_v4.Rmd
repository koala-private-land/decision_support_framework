...
outfolder <- "outputs_v7"
outfoldermaps <- "outputs_v7/maps_v7"
outfoldervals <- "outputs_v7/vals_v7"
# create folder:
...
for (c in cc.names[1:length(cc.names)]){
scen <- paste0(c)
...
```{r}
scen <- "scenario2"
df <- df.org[c("LGA", "NewPropID", "npv.mean", "admin.mean", "rank", "MeanAdopt", "MeanWTA.tot", "area")]
colnames(df) <- c("puid", "NewPropID", "npv", "admin.cost", "property", "prob.property", "bid.price", "cons.benefit")
