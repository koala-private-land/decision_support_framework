...
outfolder <- "outputs_v13"
outfoldermaps <- "outputs_v13/maps_v13"
outfoldervals <- "outputs_v13/vals_v13"
# create folder:
...
##Approach 1 - Agnostic single budget 
Set up dataframe for appropriate scenario
...
##Approach 1 - Cycling through the different budgets
```{r}
for (b in b.vec[1:10]){
scen <- "approach1"
...
se.to.plot <- read_csv("outputs_v12/vals_v12/scenario2_budget_20300000_sensitivity_analysis_v1.csv")
plot(se.to.plot$q, se.to.plot$mean, xlab="no. of simulations", ylab="mean standard error", pch = 19)
jpeg(file="E:/Linkage/DSF code/private_land_conservation_DSF/outputs_v12/vals_v12/sensitivity_analysis/sensitivity_analysis.jpeg")
plot(se.to.plot$q, se.to.plot$mean, xlab="no. of simulations", ylab="mean standard error", pch = 19)
dev.off()
...
```{r, include=FALSE}
files <- list.files("E:/Linkage/DSF code/private_land_conservation_DSF/outputs_v13/vals_v13/", pattern = "approach1_budget+", full.names = T, recursive = TRUE)
a <- read.csv(files[7])
b <- read.csv(files[8])
c <- read.csv(files[9])
d <- read.csv(files[10])
...
files <- list.files("E:/Linkage/DSF code/private_land_conservation_DSF/outputs_v13/vals_v13/", pattern = "approach2_vs_4+", full.names = T, recursive = TRUE)
a <- read.csv(files[7])
b <- read.csv(files[8])
c <- read.csv(files[9])
d <- read.csv(files[10])
...
files <- list.files("E:/Linkage/DSF code/private_land_conservation_DSF/outputs_v13/vals_v13/", pattern = "t7approach3_budget_", full.names = T, recursive = TRUE)
a <- read.csv(files[7])
b <- read.csv(files[8])
c <- read.csv(files[9])
d <- read.csv(files[10])
...
files <- list.files("E:/Linkage/DSF code/private_land_conservation_DSF/outputs_v13/vals_v13/", pattern = "approach4_budget+", full.names = T, recursive = TRUE)
a <- read.csv(files[7])
b <- read.csv(files[8])
c <- read.csv(files[9])
d <- read.csv(files[10])
...
colors <- c("#B9D3EE", "#ef4236", "#FBC26B", "#43CD80")
...
ggsave("E:/Linkage/DSF code/private_land_conservation_DSF/outputs_v13/figures/df_lines_cons_incl.png", s, width = 10, height = 6)
...
files <- list.files("E:/Linkage/DSF code/private_land_conservation_DSF/outputs_v13/vals_v13/", pattern = "*csv", full.names = T, recursive = FALSE)
...
write.csv(combined.df, "E:/Linkage/DSF code/private_land_conservation_DSF/outputs_v13/all_solutions.csv")
